...
<div id="main" class="press">
	<div class="row">
		<section class="small-12 medium-6 pull-left">
	  	...
	  	<section class="small-12 medium-6">
	  		<?php foreach($page->children()->visible()->slice(4)->limit(4) as $article): ?>
	  		<article>
				<h3><a href="<?php  echo $article->url(); ?>"><?php  echo $article->media()->html(); ?>:</a></h3>
				<h2><a href="<?php  echo $article->url(); ?>"><?php  echo $article->title()->html(); ?></a></h2>
				<p><a href="<?php  echo $article->link()->html(); ?>" target="_blank"><?php  echo $article->link()->html(); ?>&nbsp;<i class="fa fa-external-link"></i></a></p>
	...
	<div class="row">
		<section class="small-12 medium-6 pull-left">
		  	<?php foreach($page->children()->visible()->slice(8)->limit(4) as $article): ?>
		  	<article>
		  		<h3><a href="<?php  echo $article->url(); ?>"><?php  echo $article->media()->html(); ?>:</a></h3>
				<h2><a href="<?php  echo $article->url(); ?>"><?php  echo $article->title()->html(); ?></a></h2>
				<p><a href="<?php  echo $article->link()->html(); ?>" target="_blank"><?php  echo $article->link()->html(); ?>&nbsp;<i class="fa fa-external-link"></i></a></p>
	  	...
	  	<section class="small-12 medium-6">
	  		<?php foreach($page->children()->visible()->slice(12)->limit(4) as $article): ?>
	  		<article>
				<h3><a href="<?php  echo $article->url(); ?>"><?php  echo $article->media()->html(); ?>:</a></h3>
				<h2><a href="<?php  echo $article->url(); ?>"><?php  echo $article->title()->html(); ?></a></h2>
				<p><a href="<?php  echo $article->link()->html(); ?>" target="_blank"><?php  echo $article->link()->html(); ?>&nbsp;<i class="fa fa-external-link"></i></a></p>
	...
	<div class="row">
		<section class="small-12 medium-6 pull-left">
		  	<?php foreach($page->children()->visible()->slice(16)->limit(4) as $article): ?>
		  	<article>
		  		<h3><a href="<?php  echo $article->url(); ?>"><?php  echo $article->media()->html(); ?>:</a></h3>
				<h2><a href="<?php  echo $article->url(); ?>"><?php  echo $article->title()->html(); ?></a></h2>
				<p><a href="<?php  echo $article->link()->html(); ?>" target="_blank"><?php  echo $article->link()->html(); ?>&nbsp;<i class="fa fa-external-link"></i></a></p>
	  	...
	  	<section class="small-12 medium-6">
	  		<?php foreach($page->children()->visible()->slice(20)->limit(4) as $article): ?>
	  		<article>
				<h3><a href="<?php  echo $article->url(); ?>"><?php  echo $article->media()->html(); ?>:</a></h3>
				<h2><a href="<?php  echo $article->url(); ?>"><?php  echo $article->title()->html(); ?></a></h2>
				<p><a href="<?php  echo $article->link()->html(); ?>" target="_blank"><?php  echo $article->link()->html(); ?>&nbsp;<i class="fa fa-external-link"></i></a></p>
